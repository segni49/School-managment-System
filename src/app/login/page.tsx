      ...
      return (
        <div className="bg-gradient-to-r flex justify-center items-center min-h-screen from-blue-500 to-purple-50">
          <div className="flex drop-shadow-2xl flex-row rounded-3xl h-100 justify-center items-center ">
            <div className="flex bg-[url('/image.png')] h-full rounded-l-3xl  bg-cover bg-center bg-no-repeat flex-col w-1/2 justify-center items-center"
                 >
                <h1 className="text-3xl font-bold text-shadow-amber-50">Welcome</h1>
                <p className="text-xl text-center italic p-2 mt-3">A Student Management System for Yetwlid Tesfa primary and Secondary School.</p>
            </div>
